...
#define		BLOOD_COLOR_GREEN	BLOOD_COLOR_YELLOW // wtf is this?
...
extern void			UTIL_MakeBloodPuddle(Vector origin, Vector angles, int bloodcolor, float bloodscale);
...
#define SF_BREAK_EXPLOSION		64 // can only be broken by a explosion
