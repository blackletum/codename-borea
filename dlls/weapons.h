...
public:
	...
	static CGrenade *ThrowRock( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time );
...
#define	_9MM_MAX_CARRY			36
#define MP54_MAX_CARRY			90
#define _357_MAX_CARRY			12
#define BUCKSHOT_MAX_CARRY		12
